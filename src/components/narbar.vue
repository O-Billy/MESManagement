    ...
    <div class="h-[86px]">
      <div class="relative" id="input">
        <input
          ...
          class="block w-[25%] text-base h-[40px] px-4 mt-[22px] ml-[22px] text-black bg-[#FBF7F4] rounded-[8px] border border-slate-200 appearance-none focus:border-transparent focus:outline focus:outline-1 focus:outline-[#BF5940] focus:ring-0 hover:border-brand-500-secondary- peer invalid:border-error-500 invalid:focus:border-error-500 overflow-ellipsis overflow-hidden text-nowrap pr-[48px]"
          id="floating_outlined"
          type="text"
        />
        <label
          class="peer-placeholder-shown:-z-10 font-management-font italic text-[14px] text-[#BF5940] peer-focus:z-10 absolute ml-[22px]  leading-[150%] text-primary peer-focus:text-primary peer-invalid:text-error-500 focus:invalid:text-error-500 duration-300 transform -translate-y-[1.2rem] scale-75 top-2 z-10 origin-[0] bg-white data-[disabled]:bg-gray-50-background- px-2 peer-focus:px-2 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-[1.2rem] rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1"
        ...
        <div class="absolute top-0 lg:mt-[-10px] right-3 flex items-center gap-4">
          <div class="flex items-center gap-4">
            ...
            <img
              alt="profile"
              src="../assets/img/narbar/billy-profile-img.jpg"
              class="inline-block object-cover object-center w-12 h-12 rounded-full cursor-pointer"
              @click="toggleMenu"
            />
          ...
          <ul
            ref="profileMenu"
            role="menu"
            class="absolute top-full right-0 mt-2 flex min-w-[180px] flex-col gap-2 overflow-auto rounded-md border border-blue-gray-50 bg-white p-3 font-sans text-sm font-normal text-blue-gray-500 shadow-lg shadow-blue-gray-500/10 focus:outline-none hidden"
          >
            <li>
              <button role="menuitem"
              class="flex w-full cursor-pointer select-none items-center gap-2 rounded-md px-3 pt-[9px] pb-2 text-start leading-tight outline-none transition-all hover:bg-[#FCDEC6] hover:text-black">
